...
class Presenter(Protocol):
    ...
    def handle_sort_order_changed(self, tuple):
        ...
class SortListWidget(DragWidgetContainer, QListWidget):

    def __init__(self, title: str, drag_widget_dict: Dict, presenter: Presenter, id=0, parent=None):
    ...
    def populate_drag_widgets(self):
        for label, sort_value, in self.drag_widget_dict:
           self.add_checkbox(label, sort_value) 
